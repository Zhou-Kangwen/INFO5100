...
public class Lab7 {
    ...
    private void runAnalysis(){
        ...
        helper.getTopFiveLikedComments();
        helper.getAverageLikesPerCommentsComments();
        helper.getPostWithMostLikedComment();
        helper.getPostWithMostComments();
        helper.getTopFiveInactiveUserByPost();
        helper.getTopFiveInactiveUserByComments();
        helper.getTopFiveInactiveUserByOverall();
        helper.getTopFiveProactiveUserByOverall();
    }
}
