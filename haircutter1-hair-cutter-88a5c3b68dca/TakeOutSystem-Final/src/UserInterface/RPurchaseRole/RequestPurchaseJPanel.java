...
public class RequestPurchaseJPanel extends javax.swing.JPanel {
    ...
    public RequestPurchaseJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, TakeOutSystem business) {
        initComponents();
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        for(Component c : comps){
            if(c instanceof RPurchaseWorkAreaJPanel){
                RPurchaseWorkAreaJPanel panel = (RPurchaseWorkAreaJPanel) c;
