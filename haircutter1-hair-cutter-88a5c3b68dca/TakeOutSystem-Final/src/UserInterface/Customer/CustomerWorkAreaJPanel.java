...
public class CustomerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public CustomerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account,TakeOutSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(38, 38, 38)
                .addComponent(txtCost, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(179, 179, 179))
            .addGroup(layout.createSequentialGroup()
    ...
    private void populateResCob(Network network){
        ...
        for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
            if(enterprise.getEnterpriseType().getValue().equals("Restaurant"))
    ...
    private void ResCobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ResCobActionPerformed
        // TODO add your handling code here:
        RestaurantEnterprise enterprise = (RestaurantEnterprise) ResCob.getSelectedItem();
        if (enterprise != null){
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(selectedrow >=0)
        {
            Dish  vs = (Dish)CartTable.getValueAt(selectedrow,0);
