...
public class AddDishJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form AddDishJPanel
     */
    ...
    public AddDishJPanel(JPanel userProcessContainer, Menu menu, TakeOutSystem business,Enterprise enterprise) {
        initComponents();
    ...
    private void btnComfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComfirmActionPerformed
        ...
        try {
            ...
            for(Dish dish:menu.getMenuList()){
                if(dish.getDishName().equals(txtName.getText())){
            ...
            if(exist==false)
                {
                Dish dish = menu.updateMenu();
                dish.setDishName(txtName.getText());
